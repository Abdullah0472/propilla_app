            ...
            appBar: AppBar(
              bottom: PreferredSize(
                ...
                child: Column(
                  ...
                  children: [
                      Text("Upload Property",  style: GoogleFonts.lato(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          Column(
                            ...
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 10),
                              child: textInputField("Bedroom", 50, 150, true,_.propertyNumericValidator, _.bedTextController,1),
                            )
                          ],),
                          Column(
                            mainAxisAlignment: MainAxisAlignment.start,
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.symmetric(vertical: 10),
                                child: textInputField("Bathroom", 50, 150, true,_.propertyNumericValidator, _.bathTextController,1),
                              )
                            ],),
                        ],),
                      ),
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.symmetric(vertical: 10),
                                  child: textInputField("Enter Area", 50, 150, true,_.propertyNumericValidator, _.areaTextController,1),
                                )
                              ],),
                            Column(
                              mainAxisAlignment: MainAxisAlignment.start,
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.symmetric(vertical: 10),
                                  child: textInputField("Enter Price", 50, 150, true,_.propertyNumericValidator, _.priceTextController,1),
                                ),
                              ],),
                          ],),
                      ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                          Text("Add Utilities",style: GoogleFonts.lato(
                            fontStyle: FontStyle.normal,
                            fontWeight: FontWeight.bold,
                            color: shadowColor,
                            fontSize: 18,
                          ),),
                          Text("Distance in time",style: GoogleFonts.lato(
                            fontStyle: FontStyle.normal,
                            fontWeight: FontWeight.w600,
                            color: inActiveColor,
                            fontSize: 18,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          Row(
                            children: [
                              const Icon(MdiIcons.hospital,size: 35,),
                              Text("   Hospital",style: GoogleFonts.lato(
                                fontSize: 18,
                                fontWeight: FontWeight.w600,
                                color: shadowColor,
                              ),),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Row(
                              children: [
                                const Icon(MdiIcons.school,size: 35,),
                                Text("   School",style: GoogleFonts.lato(
                                  fontSize: 18,
                                  fontWeight: FontWeight.w600,
                                  color: shadowColor,
                                ),),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Row(
                              children: [
                                const Icon(MdiIcons.airplane,size: 35,),
                                Text("   Airport",style: GoogleFonts.lato(
                                  fontSize: 18,
                                  fontWeight: FontWeight.w600,
                                  color: shadowColor,
                                ),),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Row(
                              children: [
                                const Icon(MdiIcons.shopping,size: 35,),
                                Text("   Market",style: GoogleFonts.lato(
                                  fontSize: 18,
                                  fontWeight: FontWeight.w600,
                                  color: shadowColor,
                                ),),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Row(
                              children: [
                                const Icon(MdiIcons.mosque,size: 35,),
                                Text("   Masjid",style: GoogleFonts.lato(
                                  fontSize: 18,
                                  fontWeight: FontWeight.w600,
                                  color: shadowColor,
                                ),),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Row(
                              children: [
                                const Icon(MdiIcons.grass,size: 35,),
                                Text("   Park",style: GoogleFonts.lato(
                                  fontSize: 18,
                                  fontWeight: FontWeight.w600,
                                  color: shadowColor,
                                ),),
